...
const bodyMap = {
plaid_link_token: {client_id:data.client_id,secret:***REDACTED***'sg_'+(data.name||'user').replace(/\s/g,'_')},client_name:'SuperGrok',products:['auth','balance'],country_codes:['US'],language:'en'},
plaid_exchange:   {client_id:data.client_id,secret:***REDACTED***
plaid_balance:    {client_id:data.client_id,secret:***REDACTED***
};
