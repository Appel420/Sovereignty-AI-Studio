...
echo ""
echo "The Node bridge unifies all backends on port 9899:"
echo "  http://localhost:9899/health           – bridge health"
echo "  http://localhost:9899/api/weather      – weather API"
echo "  http://localhost:9899/api/forecast     – forecast API"
echo "  http://localhost:9899/api/v1/...       – FastAPI backend"
echo "  ws://localhost:9899/ws/alerts          – real-time alerts"