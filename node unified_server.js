...
- Port: 9898 (PRIMARY — only port you need)
- Run: node unified_server.js
  */
  ‘use strict’;
  // 📌 AGENT: Port 9898 is PRIMARY. Old 9000 dead. 8443 alias only. Fixed: 2026-03-04T05:39:41Z
...
// ─── CONFIG ───────────────────────────────────────────────────────────
const PORT_UNIFIED = parseInt(process.env.PORT_UNIFIED || ‘9898’); // ✅ PRIMARY
const PORT_BRIDGE  = parseInt(process.env.PORT_BRIDGE  || ‘9000’);  // alias only
const PORT_AUTH    = parseInt(process.env.PORT_AUTH    || ‘8443’);  // alias only
...
“president”: “adcddb276b0004bb8406fcb933097394f8e0a4b1e298ccfb73fa8dc9a5eea4bb”,
“prime_minister”: “4ac5dae4a71614f188aa5ac2774c95491e88703c49897978565888aa1dfbc6b6”,
“un_sg”: “5ed4e15f51343dc8c85e2350f6d0234bbf7e5e92ee561e51a7513d313a18e89c”,
“judge”: “1f713591f4b4281ef62891bc304dc94dcc0bb547665d54f14f2ae1af7bd6bebf”,
“intel_officer”: “495b132799804c8960c243564eb4ee6794f5c2dc5c7b378f78ff97c7fd097986”,
“cyber_cmd”: “acee226c5544c5140ad120df13da59748e232d898759c36474f38e473f2a9bb2”,
“surgeon_general”: “0209f04b8849515088bcb5e0eb7360fda8d987e175ae5fbb8fc9fb7b6ac2f6f8”,
“supreme_court”: “392b3360028a2981af58159cb65bb249449fa39eae09eec07560f5736a15be52”,
“gov_official”: “cc7f92616d58c72aa6ca1b3dd2b3de9beb2f3b23eede4815c5ab67ae498f8da2”,
“military”: “6f07e44287882657a6270afd8c31cd8770fd2a82cc60836347186a070925083c”,
“ambassador”: “393faa59a9977b57dc1d6ecc02d2957b486eb0d188c56c99cf8e9554ffb75def”,
“foreign_minister”: “a45cc9b855313c995bed3ebc40bd61dd13145e1e836c957332dae229256ac767”,
“interpol”: “6439f6c7d1d3fb2d0092deed0a5cfacd1d1c809c372a148ceb31997ed2517bef”,
“attorney_general”: “ab9d89a0a3dd854cc6b0a087ef07a77b1b042587fd7f83d177cf5669fbcfbccf”,
“admin”: “c8e4f143ea5b8e73776f0226b100d6651e0f750d036b22a47743222e5cc79699”,
“undercover”: “6939a7deba61a0d088499ebe9a1a4aad897fc0a6818aa01724dbd03af9ac685e”
};
...
const phClient = (passphrase_hash||’’).toLowerCase().trim();
const phStored = (ex||’’).toLowerCase().trim();
const a = Buffer.from(phClient.padEnd(64,‘0’).slice(0,64), ‘hex’);
const b = Buffer.from(phStored.padEnd(64,‘0’).slice(0,64), ‘hex’);
if (phClient.length !== 64 || phStored.length !== 64 || !crypto.timingSafeEqual(a, b)) {
...
process.stdout.write(‘║  PRIMARY   ws://127.0.0.1:9898 (bridge + auth + WS)  ║\n’);
process.stdout.write(‘║  Alias     :9000 → 9898 (optional compat)             ║\n’);
process.stdout.write(‘║  Alias     :8443 → 9898 (optional compat)             ║\n’);
...
tgt.on(‘close’, () => { try{ws2.close();}catch(*){} });
ws2.on(‘close’, () => { try{tgt.close();}catch(*){} });
});
tgt.on(‘error’, () => { try{ws2.close();}catch(*){} });
});
